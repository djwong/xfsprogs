...
#define XFS_XFLAG_REFLINK	FS_XFLAG_REFLINK
#define XFS_XFLAG_COWEXTSIZE	FS_XFLAG_COWEXTSIZE
...
struct getfsmapx {
	...
	__s64		fmv_oflags;	/* mapping flags */
	__s64		fmv_iflags;	/* control flags (1st structure) */
